...
AABPawn::AABPawn()
{
	...
	// cardboard character asset from InfinityBlade:Warrior
	...
	// Setting animation blueprint to this
...
void AABPawn::BeginPlay()
{
	...
	// Enrolling animation asset one by one -> disadvatange of using bigger set of assets -> use animation blueprint instead
	
	//Mesh->SetAnimationMode(EAnimationMode::AnimationSingleNode);
	//UAnimationAsset* AnimAsset = LoadObject<UAnimationAsset>(nullptr, TEXT
